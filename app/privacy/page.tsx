  ...
  return (
    <ContentWrapper>
      <div className="text-neutral-100 text-lg">
        <br />
        <br />
        Cut to Black Prize/Call Sheet Media, LLC Privacy Policy - Updated May 2,
        2024
        <br />
        <br />
        ...
        us), unless a different policy is displayed. We offer a wide range of
        products and services. We refer to all of these products and services,
        ...
        <br />
        <br />
        Where we provide the Services under contract with an organization, that
        organization controls the information processed by the Services. This
        policy does not apply to the extent we process personal information in
        ...
        billing information, when you register for the Services.
        <br />
        <br />
        Content you provide through our products: The Services include the Call
        Sheet Media, LLC ("CSM") products you use, where we collect and store
        content that you post, send, receive and share. This content includes
        any information about you that you may choose to include.
        <br />
        <br />
        ...
        register for certain paid Services. You might also provide payment
        ...
        and filenames of attachments you upload to the Services; search terms;
        and how you interact with others on the Services. We also collect
        ...
        "Content you provide through our products," above.
        <br />
        <br />
        ...
        <br />
        <br />
        Cookies and Other Tracking Technologies: CSM and our third-party
        ...
        provide it in order to invite you to the Services.
        <br />
        <br />
        Other services you link to your account: We receive information about
        you when you integrate third-party apps or link a third-party service
        with our Services. For example, if you create an account or log into the
        Services using your Google credentials, we receive your name and email
        address as permitted by your Google profile settings in order to
        authenticate you. You may also integrate our Services with other
        ...
        Services or so your organization can limit access to certain users. The
        information we receive when you link or integrate our Services with a
        third-party service depends on the settings, permissions and privacy
        policy controlled by that third-party service. You should always check
        the privacy settings and notices in these third-party services to
        understand what data may be disclosed to us or shared with our Services.
        <br />
        <br />
        CSM Companies: We receive information about you from other CSM corporate
        affiliates, in accordance with their terms and policies.
        <br />
        <br />
        CSM Partners: We work with a global network of partners who provide
        ...
        and technical contact information, company name, what CSM Services you
        have purchased or may be interested in, evaluation information you have
        provided, what events you have attended, and what country you are in.
        <br />
        <br />
        ...
        users and the public. We automatically analyze and aggregate search
        terms to improve the accuracy and relevance of suggested topics that
        ...
        updates, security alerts, and administrative messages. Depending on your
        chosen method of contact, we may send you SMS notifications or call you.
        We also provide tailored communications based on your activity and
        interactions with us. For example, certain actions you take in the
        Services may automatically trigger a feature or third-party app
        suggestion within the Services that would make that task easier. We also
        send you communications as you onboard to a particular Service to help
        you become more proficient in using that Service. These communications
        are part of the Services and in most cases you cannot opt out of them.
        If an opt out is available, you will find that option within the
        ...
        including by email and by displaying CSM ads on other companies'
        ...
        give us express permission to do so, we disclose information to a third
        ...
        interests), such as for research and development, to market and promote
        the Services and to protect our legal rights and interests; You give us
        consent to do so for a specific purpose; or We need to process your data
        to comply with a legal obligation. If you have consented to our use of
        information about you for a specific purpose, you have the right to
        change your mind at any time, but this will not affect any processing
        that has already taken place. Where we are using your information
        because we or a third party have a legitimate interest to do so, you
        ...
        means disclosing information through the Services and to certain third
        parties. We disclose information we collect about you in the ways
        discussed below. Please note that information about you, your devices,
        and your behavior collected through third-party cookies, pixels, tags,
        or other tracking technologies for purposes of cross-context behavioral
        advertising may be considered a “sale” or “share” under certain US state
        laws. However, CSM is not a data broker, and we do not sell personal
        ...
        <br />
        <br />
        When you use the Services, we disclose certain information about you to
        other Service users.
        <br />
        <br />
        Community Forums: Our websites offer publicly accessible blogs, forums,
        issue trackers, and wikis (e.g., CSM Community and/or CSM Developer
        Community). You should be aware that any information you provide on
        ...
        improve, integrate, customize, support and market our Services. Data
        obtained through the short code program will not be shared with any
        third parties for their marketing reasons/purposes.
        <br />
        <br />
        ...
        storage, virtual infrastructure, payment processing, analysis,
        marketing, and other services for us, which may require them to access
        or use information about you. If a service provider needs to access
        information about you to perform services on our behalf, they do so
        under close instruction from us, including appropriate security and
        confidentiality procedures designed to protect your information.
        <br />
        <br />
        CSM Partners: We work with third parties who provide consulting, sales,
        support, and technical services to deliver and implement customer
        solutions around the Services. We may disclose your information to these
        third parties in connection with their services, such as to assist with
        billing and collections, to provide localized support, and to provide
        customizations. We may also disclose information to these third parties
        where you have agreed to that disclosure.
        <br />
        <br />
        ...
        disclose information to third parties through the Services. For example,
        ...
        When you intentionally interact with these third parties, we may
        disclose certain information to those third parties or receive
        information with those third parties, consistent with your privacy
        settings on the third-party service. Such information may include
        contact information, identification, and demographic information, and
        device information and identifiers. You should always check the privacy
        settings and notices in these third-party services to understand how
        those third-parties may use your information.
        <br />
        <br />
        With your consent: We disclose information about you to third parties
        ...
        <br />
        <br />
        Compliance with Enforcement Requests and Applicable Laws; Enforcement of
        Our Rights: In exceptional circumstances, we may disclose information
        about you to a third party if we believe that sharing is reasonably
        necessary to (a) comply with any applicable law, regulation, legal
        process or governmental request, including to meet national security
        requirements, (b) enforce our agreements, policies and terms of service,
        (c) protect the security or integrity of our products and services, (d)
        protect CSM, our customers or the public from harm or illegal
        ...
        death or serious bodily injury of any person. For more information on
        how we respond to government requests, see our Guidelines for Law
        Enforcement and our Transparency Report.
        <br />
        <br />
        Disclosing to affiliated companies
        <br />
        <br />
        We disclose information we collect to affiliated companies and, in some
        cases, to prospective affiliates. Affiliated companies are companies
        owned or operated by us. The protections of this privacy policy apply to
        the information we disclose in these circumstances.
        <br />
        <br />
        CSM companies: We disclose information we have about you to other CSM
        corporate affiliates in order to operate and improve products and
        services and to offer other CSM affiliated services to you. This
        includes companies that own or operate the Services.
        <br />
        <br />
        Business Transfers: We may disclose or transfer information we collect
        ...
        rests with you and not CSM. We strongly recommend that server or data
        center users configure SSL to prevent interception of information
        ...
        decide to re-activate the Services. aWe also retain some of your
        ...
        using your CSM account. We retain information derived from cookies and
        other tracking technologies for a reasonable period of time from the
        ...
        <br />
        <br />
        Where applicable under local law, you may have certain rights with
        respect to your personal information.
        <br />
        <br />
        Depending on which jurisdiction you live in, you may have the right to
        request information about our processing of your information, to request
        a copy of your information, to object to our use of your information
        (including for marketing purposes), to request the deletion or
        restriction of your information, to request your information in a
        structured, electronic format, to request to correct or update your
        information, to request to opt out of “sales” or “sharing” of personal
        information and targeted advertising (as these terms are defined under
        applicable law), and to request to opt out of certain profiling
        activities. Below, we describe the tools and processes for making these
        requests. You can exercise some of the choices by logging into the
        Services and using settings available within the Services or your
        account.
        <br />
        <br />
        ...
        interests to keep. Where you have asked us to disclose data to third
        ...
        feel your rights were infringed. Where applicable under local law, you
        may also contact us as provided in the “Contact Us” section below to
        appeal any decision we make relating to your request to exercise your
        rights.
        <br />
        <br />
        Delete your information: Our Services and related documentation give you
        the ability to delete certain information about you from within the
        Service. For example, you can remove content that contains information
        about you using the key word search and editing tools associated with
        that content, and you can remove certain profile information within your
        ...
        administrator does not object (where applicable).
        <br />
        <br />
        ...
        <br />
        <br />
        Turn off Cookie Controls: Relevant browser-based cookie controls are
        described in our Cookies & Tracking Notice.
        <br />
        <br />
        ...
        indicating you do not wish to be tracked. Our websites may not respond
        to all browser-based DNT signals; however, our websites do respond to
        the Global Privacy Control (“GPC”) to opt-out of “sales” of personal
        information and targeted advertising in certain locales. For more
        information on the GPC and how to use a browser or browser extension
        incorporating the GPC signal, see https://globalprivacycontrol.org/. You
        can also use the range of other tools we provide to control data
        collection and use, including the ability to opt out of receiving
        marketing from us as described above.
        <br />
        <br />
        ...
        <br />
        <br />
        We collect information globally and may transfer, process, and store
        your information outside of your country of residence, to wherever we or
        our third-party service providers operate for the purpose of providing
        you the Services. Whenever we transfer your information, we take steps
        to protect it.
        <br />
        <br />
        International transfers within the CSM Companies: To facilitate our
        global operations, we transfer information globally and allow access to
        that information from countries in which the CSM owned or operated
        ...
        based. When we disclose information about you within and among CSM
        corporate affiliates, we make use of the Data Privacy Framework to
        receive personal data transfers from the European Union/European
        Economic Area to the U.S. (see “Data Privacy Framework Notice” section
        below), and the standard contractual data protection clauses, which have
        been approved by the European Commission, to safeguard the transfer of
        information we collect from the European Economic Area, the United
        Kingdom (the "UK"), and Switzerland. Refer to this page for a list of
        countries to which we regularly transfer personal data.
        <br />
        <br />
        ...
        When we disclose information of customers in the European Economic Area,
        ...
        <br />
        <br />
        On July 10, 2023, the European Commission’s adequacy decision for the
        EU-U.S. Data Privacy Framework (EU-U.S. DPF) entered into force.
        <br />
        <br />
        Call Sheet Media, LLC adheres to the Data Privacy Framework Principles
        regarding the collection, use, and retention of personal data that is
        transferred from the European Union and Switzerland to the U.S.
        <br />
        <br />
        CSM complies with the EU-U.S. Data Privacy Framework (EU-U.S. DPF), the
        ...
        Commerce. CSM has certified to the U.S. Department of Commerce that it
        ...
        the European Union and the United Kingdom in reliance on the EU-U.S. DPF
        and the UK Extension to the EU-U.S. DPF. CSM has certified to the U.S.
        ...
        Principles, the DPF Principles shall govern. To learn more about the
        Data Privacy Framework Program, please visit the Data Privacy Framework
        Program website here. To view CSM’s certifications, search for “CSM” in
        the Data Privacy Framework List.
        <br />
        <br />
        As required under the principles, when we receive information under the
        ...
        Privacy Framework related (or general privacy-related) complaint. If you
        ...
        of data protection authorities in the European Economic Area, and/or the
        Swiss Federal Data Protection and Information Commissioner (as
        applicable) in relation to unresolved complaints (as further described
        in the Data Privacy Framework Principles). You may also contact your
        local data protection authority within the European Economic Area or
        Switzerland (as applicable) for unresolved complaints.
        <br />
        <br />
        Under certain conditions, more fully described on the Data Privacy
        Framework website, including when other dispute resolution procedures
        have been exhausted, you may invoke binding arbitration.
        <br />
        <br />
        Call Sheet Media, LLC is subject to the investigatory and enforcement
        ...
        are intended to supplement the CSM Privacy Policy with information
        required by California law.
        <br />
        <br />
        Below describes the categories of personal information we collected in
        the past 12 months, the purposes for which we may collect and disclose
        this information, the categories of recipients of disclosures made for
        business purposes in the past 12 months, and the categories of
        recipients of disclosures made in the past 12 months that may be
        considered “sales” of personal information or “sharing” of personal
        information for cross-context behavioral advertising under California
        law.
        <br />
        <br />
        Category of Information Purpose(s) for Collecting & Disclosing
        Recipients of Disclosures for Business Purposes Recipients of “Sales” or
        “Sharing” Identifiers, such as name, email address, unique identifiers
        associated with user or user account, IP Address
        <br />
        <br />
        Providing the Services User authentication Service access controls
        Billing Analytics and research Marketing Detecting security incidents
        Debugging Internal research Service enhancements Customer support CSM
        Companies CSM Partners Service Providers Third Party Apps Third Party
        ...
        <br />
        <br />
        Providing the Services Billing Analytics and research Marketing
        Detecting security incidents Debugging Internal research Service
        enhancements Customer support CSM Companies CSM Partners Service
        Providers -NA-
        <br />
        <br />
        Internet or other electronic network activity information, such as
        information about your usage of the Services, pseudonymous IDs,
        clickstream data, device and connection information, browser
        information, crash data, referring/exit URLs, IP Address
        <br />
        <br />
        Providing the Services Internal research Service enhancements CSM
        Companies CSM Partners Event Sponsors Service Providers -NA-
        <br />
        <br />
        ...
        Customer support CSM Companies CSM Partners Service Providers -NA-
        <br />
        <br />
        ...
        <br />
        <br />
        Providing the Services Internal research Service enhancements
        Marketing-Customer support CSM Companies CSM Partners Service Providers
        ...
        <br />
        <br />
        Providing the Services Internal research Marketing CSM Companies Service
        Providers Third Party Advertising Providers
        <br />
        <br />
        Sensitive personal information, such as login credentials and passwords
        <br />
        <br />
        User authentication Service access controls CSM Companies Service
        Providers -NA-
        <br />
        <br />
        If you have questions about the categories of information we may collect
        about you or the sources of such information, please be sure to visit
        the section of this policy called, “What information we collect about
        you.” For more details about our processing activities, please be sure
        to visit the section called, “How we use information we collect.” And
        for more information about how we may disclose information to third
        parties, please visit the section called, “How we disclose information
        we collect.”
        <br />
        <br />
        Sensitive personal information: We do not use or disclose sensitive
        personal information for purposes other than permitted under applicable
        law.
        <br />
        <br />
        Retention: We retain your personal information for as long as necessary
        to carry out the business purposes described in this policy, or as
        otherwise required under law. The length of retention may vary depending
        upon factors such as recordkeeping or legal compliance requirements, the
        need to resolve inquiries or complaints, and the existence of an ongoing
        relationship with you. Please visit the “How long we keep information”
        section of this privacy policy for more information about specific
        retention criteria for different categories of personal information.
        <br />
        <br />
        Exercising your rights: If you are a California resident, there are some
        additional rights that may be available to you under the California
        Consumer Protection Act (“CCPA”). This policy explains the tools that we
        have made available to you to exercise your data rights under the CCPA,
        including such as the rights to request information about how we process
        your personal information, request deletion and the right to request
        access to the specific pieces of categories of personal information we
        have collected about you.
        <br />
        <br />
        For more information on how to exercise these your rights, please visit
        the “How to access and control your information” section of this policy.
        We encourage you to manage your information, and to make use of the
        privacy controls we have included in our Services. You will not be
        discriminated against for exercising any of your privacy rights under
        the CCPA. In order to protect your information from unauthorized access
        or deletion, we may require you to provide additional information to for
        verification your identity. If we cannot verify your identity, we will
        not be able to fulfill your requests to know, access provide, correct,
        or delete your information.
        <br />
        <br />
        Opt out of certain disclosures to third parties: You may also opt out of
        “sales” of personal information and “sharing” of personal information
        for purposes of cross-context behavioral advertising by clicking here
        and following the instructions. Where required, we also honor requests
        to opt out submitted via privacy preference signals recognized under
        applicable law, such as the Global Privacy Control (“GPC”). For more
        information on the GPC and how to use a browser or browser extension
        incorporating the GPC signal, see https://globalprivacycontrol.org/. We
        do not knowingly sell or share the personal information of consumers
        under 16 years of age.
        <br />
        <br />
        Authorized agent: You may also authorize an agent to exercise your
        rights on your behalf. To do this, you must provide the authorized agent
        with written permission to exercise your rights on your behalf, and we
        may request a copy of this written permission from the agent when they
        make a request on your behalf. We may also ask you to verify your own
        identity and directly confirm with you that you have granted permission
        ...
        we will provide a more prominent notice by adding a notice on the
        Services homepages, login screens, or by sending you an email
        notification. We will also keep prior versions of this Privacy Policy in
        an archive for your review. We encourage you to review our privacy
        policy whenever you use the Services to stay informed about our
        ...
        <br />
        <br />
        Your information is controlled by Call Sheet Media, LLC. If you have
        questions or concerns about how your information is handled, please
        direct your inquiry to CSM, which we have appointed to be responsible
        for facilitating such inquiries or, if you are a resident of the
        European Economic Area, please contact our EU Representative.
        <br />
        <br />
        Cut to Black Prize <br />
        ...
        Hollywood, CA 90028
        <br />
        E-Mail: support@callsheetmedia.com
        <br />
      </div>
    </ContentWrapper>
  );
